...
def serving_input_receiver_fn():
    ...
    input_value = tf.placeholder(dtype=tf.int64, shape=[None, 1], name='input_value')

    receive_tensors = {'input_ids': input_ids, 'input_mask': input_mask, 'segment_ids': segment_ids, 'input_value': input_value}
    features = {'input_ids': input_ids, 'input_mask': input_mask, 'segment_ids': segment_ids, "input_value": input_value}
